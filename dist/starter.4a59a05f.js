...
})({"cn8by":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 49228;
...
const controlPagination = function(toToPage) {
    (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage(toToPage));
    (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
};
...
const state = {
    ...
    search: {
        query: "",
        results: [],
        resultsPerPage: (0, _config.PAGE_SIZE),
        page: 1
    },
    bookmarks: []
};
...
const timeout = function(s) {
    return new Promise(function(_, reject) {
        setTimeout(function() {
            reject(new Error(`Request took too long! Timeout after ${(0, _config.TIMTOUT_SEC)} second`));
        }, s * 1000);
    });
};
const getJSON = async function(url) {
    try {
        ...
        if (!res.ok) throw new Error("Unalbe to get recipes at the moment. Please try again later.");
        return data;
    } catch (error) {
        throw error;
    }
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _errorMessage = "We could not find the message. Please try again later.";
    _message = "";
    ...
    <div class="recipe__details">
          ...
          ${this._data.bookmarked ? "filled" : "empty"}
          </button>
        </div>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","fraction.js":"md6n5","./View":"jSw21","../../img/icons.svg":"d6UCS"}],"md6n5":[function(require,module,exports,__globalThis) {
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../img/icons.svg":"d6UCS"}],"d6UCS":[function() {},{}],"d6UCS":[function() {},{}],"kbE4Z":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"./View":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../img/icons.svg":"d6UCS"}],"d6UCS":[function() {},{}],"1qGeA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _previewView = require("./previewView");
var _previewViewDefault = parcelHelpers.interopDefault(_previewView);
...
},{"./View":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./previewView":"6tKHS"}]},["cn8by","7dWZ8"], "7dWZ8", "parcelRequire3a11", {})
